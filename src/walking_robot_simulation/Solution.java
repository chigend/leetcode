    ...
    public static int robotSim(int[] commands, int[][] obstacles) {
        ...
        for (int i = 0; i < commands.length; i++) {
            if (commands[i] == -2) {
                ...
                int idx = (direction + 10000) % 4;
                int step = 1;
                for (; step <= commands[i]; step++) {
                    Pair<Integer, Integer> pair = new Pair<>(x + step * dx[idx], y + step * dy[idx]);
