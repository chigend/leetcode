...
public class Solution2 {
     ...
     * all non-null node provides 2 outdegree and 1 indegree (2 children and 1 parent), except root
     ...
     because the node provides an in degree. If the node is not null, we increase diff by 2, because
     it provides two out degrees. If a serialization is correct, diff should never be negative and
